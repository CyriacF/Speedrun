...
public class StartCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (plugin.isRunning()) {
            sender.sendMessage(ChatColor.RED + "Game déjà lancé!");
        }
        // Else, schedule tasks to show titles to players
        else {
            sender.sendMessage(ChatColor.GREEN + "Démarrage forcé !");
            sendStartingTimerTile(ChatColor.YELLOW + "Démarrage de la partie...", false);
            ...
            for (int i = 0; i <= countdownTime; i++) {
                ...
                Bukkit.getScheduler().scheduleSyncDelayedTask(plugin, () -> {
                    ...
                    // Else, display seconds left
                        ...
                        sendStartingTimerTile(ChatColor.YELLOW + "Démarrage dans " + seconds + "...", false);
                    }
